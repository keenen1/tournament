    ...
    return (
      <div className="eight col-12">
        <div className="teams-block col-6">
          ...
          <div className="team" onClick={() => this.changeTeam(this.state.mapua)}>MAPUA CARDINALS</div>
        </div>
        <div className="teams-block col-6">
          <div className="pool">POOL B</div>
          <div className="team" onClick={() => this.changeTeam(this.state.aztigs)}>AZTIGS 35</div>
          <div className="team" onClick={() => this.changeTeam(this.state.brick)}>BRICK CITY</div>
          <div className="team" onClick={() => this.changeTeam(this.state.westpa)}>WEST PA MORE</div>
          <div className="team" onClick={() => this.changeTeam(this.state.westside)}>WEST SIDE BALLERS</div>
        </div>
