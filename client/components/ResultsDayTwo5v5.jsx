...
const ResultsDayTwo5v5 = () => {
  return (
    <>
      <div className="category-pane">DAY TWO &gt; 5v5</div>
      <div className="results-day">
        ...
        <ResultsHourly
          ...
          court1cat={'U12'}
          court1teamA={'UFCSA WEST BLUE'}
          court1scoreA={0}
          court1teamB={'STINGERS'}
          court1scoreB={0}
          ...
          court3cat={'U15'}
          court3teamA={'UFCSA WEST NANUH NEH'}
          court3scoreA={0}
          court3teamB={'GENESIS BOLT'}
          court3scoreB={0}
        ...
        <ResultsHourly
          ...
          court1teamA={'MAVS'}
          court1scoreA={0}
          court1teamB={'GENESIS BOLT'}
          court1scoreB={0}

          court2cat={'U18'}
          court2teamA={'TGIF'}
          court2scoreA={0}
          court2teamB={'UFCSA WEST ALPHA'}
          court2scoreB={0}

          court3cat={'U15'}
          court3teamA={'MAVS 1'}
          court3scoreA={0}
          court3teamB={'UFCSA WEST EAGLES'}
          court3scoreB={0}

          court4cat={'U15'}
          court4teamA={'UFCSA NORTH'}
          court4scoreA={0}
          court4teamB={'STREET BALLERS'}
          court4scoreB={0}
        />
        <ResultsHourly
          hour={'10:30 AM'}
          ...
          court3cat={'35A'}
          court3teamA={'PILDI DAAN'}
          court3scoreA={0}
          court3teamB={'MAPUA CARDINALS'}
          court3scoreB={0}
        ...
        <ResultsHourly
          ...
          court3cat={'U9'}
          court3teamA={'A-BOTTOM'}
          court3scoreA={0}
          court3teamB={'B-BOTTOM'}
          court3scoreB={0}
        ...
        <ResultsHourly
          ...
          court3cat={'OP'}
          court3teamA={'TOP 1C (QF3)'}
          court3scoreA={0}
          court3teamB={'TOP 2D (QF3)'}
          court3scoreB={0}

          court4cat={'OP'}
          court4teamA={'TOP 1D (QF4)'}
          court4scoreA={0}
          court4teamB={'TOP 2C (QF4)'}
          court4scoreB={0}
        />
        <ResultsHourly
          hour={'1:50 PM'}
          ...
          court1cat={'OP'}
          court1teamA={'TOP 1A (QF1)'}
          court1scoreA={0}
          court1teamB={'TOP 2B (QF1)'}
          court1scoreB={0}

          court2cat={'OP'}
          court2teamA={'TOP 1B (QF2)'}
          court2scoreA={0}
          court2teamB={'TOP 2A (QF2)'}
          court2scoreB={0}

          court3cat={'U18'}
          court3teamA={'TOP 1A (SF1)'}
          court3scoreA={0}
          court3teamB={'TOP 2B (SF1)'}
          court3scoreB={0}

          court4cat={'U18'}
          court4teamA={'TOP 1B (SF2)'}
          court4scoreA={0}
          court4teamB={'TOP 2A (SF2)'}
          court4scoreB={0}
        />
        <ResultsHourly
          hour={'2:40 PM'}
        ...
        <ResultsHourly
          ...
          court4cat={'U15'}
          court4teamA={'WINNER OF SF1 (FINALS)'}
          court4scoreA={0}
          court4teamB={'WINNER OF SF2'}
          court4scoreB={0}
        />
        <ResultsHourly
          hour={'6:20 PM'}
...
export default ResultsDayTwo5v5
