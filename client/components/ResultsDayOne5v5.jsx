...
const ResultsDayOne5v5 = () => {
  return (
    <>
      <div className="category-pane">DAY ONE &gt; 5v5</div>
      <div className="results-day">
        ...
        <ResultsHourly
          ...
          court3teamA={'MAVS 1'}
          court3scoreA={0}
          court3teamB={'UFCSA NORTH'}
          court3scoreB={0}

          court4cat={'U15'}
          court4teamA={'UFCSA WEST EAGLES'}
          court4scoreA={0}
        ...
        <ResultsHourly
          ...
          court1cat={'35A'}
          court1teamA={'AZTIGS 35'}
          court1scoreA={0}
          court1teamB={'PILDI DAAN'}
          court1scoreB={0}

          court2cat={'35A'}
          court2teamA={'AUCKLAND ALPHA'}
          court2scoreA={0}
          court2teamB={'MAPUA CARDINALS'}
          court2scoreB={0}
        ...
        <ResultsHourly
          ...
          court3teamA={'MAVS 1'}
          court3scoreA={0}
          court3teamB={'STREET BALLERS'}
          court3scoreB={0}

          court4cat={'U15'}
          court4teamA={'UFCSA NORTH'}
          court4scoreA={0}
          court4teamB={'UFCSA WEST EAGLES'}
          court4scoreB={0}
        />
        <ResultsHourly
          hour={'3:00 PM'}
        ...
        <ResultsHourly
          ...
          court2cat={'35A'}
          court2teamA={'PILDI DAAN'}
          court2scoreA={0}
          court2teamB={'AUCKLAND ALPHA'}
          court2scoreB={0}
...
export default ResultsDayOne5v5
